...
INSERT INTO source_templates (id, slug, name, description, category, logo_url, docs_url, source_type, base_url, spec_url, mcp_server_url, mcp_transport, auth_type, auth_config, use_cases, is_featured, mcp_hints)
VALUES
  -- ============================================================================
  ...
  ('2e059b2b-9cef-4440-bf7f-be6d6eeb9160', 'stripe', 'Stripe', 'Payment processing platform for internet businesses', 'payments', '/integrations/stripe.svg', 'https://docs.stripe.com/api', 'openapi', 'https://api.stripe.com', 'https://raw.githubusercontent.com/stripe/openapi/master/openapi/spec3.json', NULL, NULL, 'bearer', '{"credential_field": "api_key", "credential_label": "Secret Key", "credential_placeholder": "sk_test_... or sk_live_..."}', ARRAY['Refund a customer', 'Create invoice', 'Cancel subscription', 'List customers with full details', 'Get customer by email'], true, NULL),
